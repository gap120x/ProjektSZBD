...
<head>
  <meta charset="UTF-8">
  <title>Softech- Edytuj dział</title>
...
<center>
<h1 id="tytul">Edytuj dział</h1>
<div id="formdiv">
<form:form modelAttribute="editDepartment" method="POST" action="/manage/department/edit/${editDepartment.id}/save">
<label>ID</label>

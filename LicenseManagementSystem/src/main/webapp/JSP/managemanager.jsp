...
<head>
  <meta charset="UTF-8">
  <title>Softech-Zarządzanie Managerami</title>
...
<c:set var="count" value="${count + 1}" scope="page"/>		
 ...
 <td data-column="zarzadzanie"><center><a href="/manageaccount/manager/delete/${CustomerServiceUserDto.userid}"><img border="0" alt="Delete" src="/images/delete-icon-14.jpg" width="30" height="30"></a>
	  <a href="/manageaccount/manager/edit/${CustomerServiceUserDto.userid}"><img border="0" alt="Edit" src="/images/editicon.png" width="30" height="30"></a>

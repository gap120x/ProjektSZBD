...
<head>
  <meta charset="UTF-8">
  <title>Softech-Raport Pracowników ${department.name}</title>
...
<div id="site-content">
<center>
<form:form modelAttribute="data" method="POST" action="/viewraport">
...
<label>Od</label>
 ...
 <form:select required="required" path="name">
...
<table>
  <caption>Raport ${department.name}</caption>
  <thead>
    <tr>
      <th>LP.</th>
      <th>Imie</th>

...
<center>
<div id="formdiv">
<form:form modelAttribute="customerdto" method="POST" action="/license/view">
<label>Wybierz Klienta</label>	
 ...
 <form:input required="required" type="hidden" path="enabled"/>
 <form:input required="required" type="hidden" path="discount"/>	 
	</br>
